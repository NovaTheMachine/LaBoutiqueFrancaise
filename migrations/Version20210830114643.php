 ...
 */
final class Version20210830114643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL COLLATE BINARY, lastname VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user (id, email, roles, password, firstname, lastname) SELECT id, email, roles, password, firstname, lastname FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
